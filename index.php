		...
		<div class="card__primary card__primary--d-none">
			...
			<div class="card__status">
				...
				<div class="card__suhu">
					<h1>32</h1><h5><a href="#" data-suhu="32" class="card__suhuCelsius card__suhuCelsius--active">°C</a></h5><h5>|</h5><h5><a href="#" data-suhu="89,6" class="card__suhuFahrenheit">°F</a></h5>
				</div>
			</div><!-- card__status -->
		</div>
		<div class="card__secondary card__secondary--d-none">
			<table>
				...
				<tr>
					...
					<td id="ws" data-kph="20 KPH" data-mph="30 MPH">20 KPH</td>
				</tr>
				<tr>
					<th>Arah Angin</th>
					<td width="240">dari arah Utara - Timur Laut</td>
				</tr>
			</table>
		</div>
	</div><!-- card -->
...
<script type="text/javascript" src="dist/js/cuaca.js"></script>
</body>
</html>